...
#        pin.computeAllTerms(self.model, self.data, q, v);
    ...
    def frameJacobianTimeVariation(self,q,v,index,ref_frame=pin.ReferenceFrame.LOCAL_WORLD_ALIGNED):
        return pin.frameJacobianTimeVariation(self.model,self.data,q,v,index,ref_frame)
